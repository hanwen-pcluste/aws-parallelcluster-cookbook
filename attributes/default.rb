...
# Python packages
default['cluster']['parallelcluster-version'] = '3.0.1'
default['cluster']['parallelcluster-cookbook-version'] = '3.0.1'
default['cluster']['parallelcluster-node-version'] = '3.0.1'
...
# EFA
default['cluster']['efa']['installer_version'] = '1.14.0'
